...
class StarterProducts extends StatefulWidget {
  @override
  _StarterProductsState createState() => _StarterProductsState();
}

class _StarterProductsState extends State<StarterProducts> {
  var product_list = [
    {
      "name": "Pizza Ruccola",
      "picture": "images/cats/starters.png",
      "price": 299,
      "description":
