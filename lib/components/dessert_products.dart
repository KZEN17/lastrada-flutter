...
class DessertProducts extends StatefulWidget {
  @override
  _DessertProductsState createState() => _DessertProductsState();
}

class _DessertProductsState extends State<DessertProducts> {
  var product_list = [
    {
      "name": "Pizza Ruccola",
      "picture": "images/cats/cake.png",
      "price": 299,
      "description":
